...
check_ssh_access_safety() {
    ...
    print_warning "SSH-ключи для пользователя 'root' не настроены или недействительны."
    echo
    print_info "Как настроить SSH-ключи (выполняется НА ВАШЕМ КОМПЬЮТЕРЕ, не на сервере!):"
